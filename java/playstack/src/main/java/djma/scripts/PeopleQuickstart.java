...
public class PeopleQuickstart {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        quickstart_demo(HTTP_TRANSPORT, null);
    }

    private static void quickstart_demo(NetHttpTransport transport, Credential credential)
            throws GeneralSecurityException, IOException {
        if (credential == null) {
            System.out.println("credential is null");
            credential = getCredentials(transport);
        }

        System.out.println(credential.getRefreshToken());
        // Build a new authorized API client service.
        PeopleService service = new PeopleService.Builder(transport, JSON_FACTORY, credential)
